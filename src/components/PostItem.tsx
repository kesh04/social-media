...
export const PostItem = ({ post }: Props) => {
  return (
    <div className="relative group">
      <div className="absolute -inset-1 rounded-[20px] bg-linear-to-r from-pink-600 to-purple-600 blur-sm opacity-0 group-hover:opacity-50 transition duration-300 pointer-events-none"></div>
          ...
          <div className="flex items-center space-x-2">
            {post.avatar_url ?(
              ...
              className=" w-[35px] h-[35px]  rounded-full object-cover"/>
                           ...
                           <div className="w-[35px] h-[35px] rounded-full bg-linear-to-tl from-[#8A2BE2] to-[#491F70]" />
            )
